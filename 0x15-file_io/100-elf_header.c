 ...
 * @e_ident: the pointer to array containing ELF magic numbers.
 *
 ...
 * @e_ident: the pointer to array containing ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
 ...
 * @e_ident: the pointer to array containing ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * main - display info contained in
